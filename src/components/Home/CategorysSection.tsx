    ...
    return (
        <section className="flex w-[100%] justify-between">
            {navCategorys.map((e, i) => {
                return <div key={i} onClick={() => navigate(`/category/${e}`)} className="flex bg-[rgba(241,241,241,1)] rounded-[8px] flex-col items-center pb-[30px]! w-[350px] min-h-[220px] justify-end! relative cursor-pointer">
