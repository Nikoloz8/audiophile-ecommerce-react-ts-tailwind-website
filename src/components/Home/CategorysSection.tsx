    ...
    return (
        <section className="flex w-[100%] justify-between max-sm:flex-col max-sm:items-center max-sm:gap-[100px]">
            {navCategorys.map((e, i) => {
                ...
                }} className="flex bg-[rgba(241,241,241,1)] rounded-[8px] max-md:min-h-[180px]! flex-col items-center pb-[30px]! max-xl:w-[32%]! w-[350px] max-sm:w-[100%]! min-h-[220px] justify-end! relative cursor-pointer">
